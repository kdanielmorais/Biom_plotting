...
cat ("                                                                                                                                                ")
option_list = list(
  make_option(c("-c", "--cho"), type="character", dest= "choice", action= "store", default= "BIOM",
...
if (g == "SEED") 
{
  ...
  if (h == "MAC") 
    {
    cat("                                                                                                                                                ")
    cat("Without a metadata file is only possible to create a plot of the relative abundance x samples /n")
    cat("/n")
  }else 
    {
    ## Processing with a group mean utilizing a metadata file  
